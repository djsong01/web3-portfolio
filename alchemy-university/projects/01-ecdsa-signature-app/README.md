# 🚧 **Project Cloned for Learning**  
This project was cloned and customized as part of my journey through [Alchemy University's Ethereum Bootcamp](https://university.alchemy.com).   

Below are the original instructions, followed by my notes and reflections.

## 🧠 Key Learning

- Implementing ECDSA signing from scratch (without Metamask)
- Handling secure transfer logic with message integrity
- Structuring a full-stack dApp with separate client/server layers

### 🔍 What I Did
- Cloned the original scaffold for educational use
- Added transaction history tracking on the frontend
- Hooked up real-time balance refreshing
- Restructured the layout using flexbox for better UX
- Organized the repo under my `web3-portfolio` for long-term showcase

### 🎯 Features
- Sign and verify messages using secp256k1
- Transaction history tracking
- Real-time balance updates
- Server-side verification of digital signatures
- No private keys stored or transmitted

### Project Structure
- `client/`: React frontend for wallet input, message signing, and transfer
- `server/`: Express backend for validating signatures and handling balance logic
...
Original source: [Alchemy University's Ethereum Developer Bootcamp](https://university.alchemy.com/overview/ethereum)

---

👇 Original README and setup instructions follow below:
